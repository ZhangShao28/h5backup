<template>
    <div id="modify_page">
        ...
        <div class="content">
            <div class="input_1">
                <el-input placeholder="請輸入手提電話" v-model="inputValue" id="mobile-phone"
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.u_mobilephone = this.$route.query.mobile_phone
      this.$axios.defaults.headers.ctoken = cookie.get('ctoken')
      this.dis_no = false
    },
    methods: {
      changes(el){
