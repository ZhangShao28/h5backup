    ...
    <div class="device_con">
        ...
        <div>
            <tabbar>
                ...
                <tabbar-item selected link="/DeviceListSuccess">
...
<script>
    import {Tabbar, TabbarItem,XHeader,XInput , Group, XButton,Cell,Selector,Scroller,Loading, LoadMore,Spinner } from 'vux'
    export default {
        components: {
            XHeader,
            Scroller,
