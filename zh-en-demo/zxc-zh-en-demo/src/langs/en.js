...
module.exports = {
    ...
    head_con:{
        text1:'50 million mainland travelers visiting Hong Kong every year',
    ...
    content1_txt:{
        ...
        con_text1:"●  Convenient payment method improves the consumers' payment experience, with which consumers could complete payment safely and quickly, and the cashiers’ efficiency is greatly improved.",
        con_text2:'●  WeChat Pay is familiar to domestic tourists, and the number of domestic travelers visiting Hong Kong continues to grow.',
        con_text3:'●  Customers will automatically follow the merchants’ WeChat official account after WeChat Pay, and they could purchase products through the WeChat official account, which makes marketing promotion more efficient and convenient.',
        con_text4:'●  If users pay with RMB, WeChat Pay will settle with HKD for merchants, which helps merchants avoid the risk of exchange rate fluctuations.',
